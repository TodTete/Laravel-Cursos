...
<div class="flex p-9 p-md-5 m-md-3 bg-black">
    <div class="md:w-1/2 mx-auto my-5" style="position: relative; left: 5%; top:10%;">
        <h1 class="text-4xl font-bold text-white mb-4 text-center">Programación en Objective-C</h1>
        <p class="text-lg mb-4 leading-7 text-white text-justify">Objective-C es un lenguaje de programación utilizado principalmente en el desarrollo de aplicaciones para el sistema operativo iOS y macOS. Es conocido por su integración con el marco Cocoa y su capacidad para crear aplicaciones robustas para dispositivos Apple.</p>
        <h2 class="text-xl font-bold text-white mb-2">Temas Introductorios</h2>
        <ul class="list-disc text-white ml-6">
            <li>Sintaxis básica de Objective-C</li>
            <li>Programación orientada a objetos en Objective-C</li>
            <li>Uso del framework Cocoa</li>
            <li>Desarrollo de aplicaciones iOS y macOS</li>
            <li>Interacción con UIKit y AppKit</li>
        </ul>
        <br>
    ...
    <div class="md:w-1/2">
        <img src="https://i.pinimg.com/originals/2f/f2/01/2ff2014423bbd45071c8729d980ccea2.gif" style="max-width: 80%; position: relative; left: 20%; top:6%;" alt="Ilustración de lenguajes de programación" class="w-full h-auto rounded-lg">
    </div>
</div>
