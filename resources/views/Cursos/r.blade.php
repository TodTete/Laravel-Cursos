...
<div class="flex p-9 p-md-5 m-md-3 bg-black">
    <div class="md:w-1/2 mx-auto my-5" style="position: relative; left: 5%; top:10%;">
        <h1 class="text-4xl font-bold text-white mb-4 text-center">Análisis de Datos con R</h1>
        <p class="text-lg mb-4 leading-7 text-white text-justify">R es un lenguaje de programación y entorno de software utilizado para análisis estadístico y visualización de datos. Es especialmente popular en el ámbito de la ciencia de datos y la estadística. Aprender R te proporcionará herramientas poderosas para explorar y comprender conjuntos de datos complejos.</p>
        <h2 class="text-xl font-bold text-white mb-2">Temas Introductorios</h2>
        <ul class="list-disc text-white ml-6">
            <li>Instalación y configuración de R</li>
            <li>Manipulación de datos con R</li>
            <li>Estadísticas descriptivas y gráficos</li>
            <li>Análisis de regresión</li>
            <li>Introducción a la programación en R</li>
            <li>Visualización de datos con ggplot2</li>
        </ul>
        <br>
    ...
    <div class="md:w-1/2">
        <img src="https://i.pinimg.com/originals/0a/6d/63/0a6d634748068a2098a477fee671e23f.gif" style="max-width: 80%; position: relative; left: 20%; top:6%;" alt="Ilustración de lenguajes de programación" class="w-full h-auto rounded-lg">
    </div>
</div>
