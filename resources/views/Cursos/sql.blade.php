...
<div class="flex p-9 p-md-5 m-md-3 bg-black">
    <div class="md:w-1/2 mx-auto my-5" style="position: relative; left: 5%; top:10%;">
        <h1 class="text-4xl font-bold text-white mb-4 text-center">Programación SQL</h1>
        <p class="text-lg mb-4 leading-7 text-white text-justify">SQL (Structured Query Language) es un lenguaje de programación utilizado para gestionar y manipular bases de datos relacionales. Es esencial para cualquier persona que trabaje con bases de datos en el desarrollo de software y sistemas.</p>
        ...
        <ul class="list-disc text-white ml-6">
            ...
            <li>Conceptos básicos de SQL</li>
            <li>Consultas SELECT</li>
            <li>Modificación de datos (INSERT, UPDATE, DELETE)</li>
    ...
    <div class="md:w-1/2">
        <img src="https://1.bp.blogspot.com/-mNAYu8OwYOw/W82aXiapHYI/AAAAAAAAGkc/I3wcIO43zSs8n08jOmLSrOBLS6AJXsnEgCLcBGAs/s1600/InsistentSardonicAppaloosa-size_restricted.gif" style="max-width: 50%; position: relative; left: 20%; top:6%;" alt="Ilustración de lenguajes de programación" class="w-full h-auto rounded-lg">
    </div>
</div>
