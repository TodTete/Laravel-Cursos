...
<div class="flex p-9 p-md-5 m-md-3 bg-black">
    <div class="md:w-1/2 mx-auto my-5" style="position: relative; left: 5%; top:10%;">
        <h1 class="text-4xl font-bold text-white text-center mb-4">Explorando NoSQL: Bases de Datos No Relacionales</h1>
        <p class="text-lg mb-4 leading-7 text-white text-justify">NoSQL engloba una variedad de sistemas de gestión de bases de datos que difieren del modelo relacional tradicional. En este curso, aprenderás sobre las ventajas y casos de uso de las bases de datos NoSQL, así como las diferencias clave con los sistemas de bases de datos relacionales.</p>
        ...
        <ul class="list-disc text-white ml-6">
            ...
            <li>Tipos de bases de datos NoSQL (Documentales, Clave-Valor, Columnares, Grafos)</li>
            <li>Comparación entre bases de datos NoSQL y SQL</li>
            <li>Modelado de datos NoSQL</li>
            <li>Implementación práctica con ejemplos</li>
        </ul>
        <br>
    ...
    <div class="md:w-1/2">
        <img src="https://vittehenterprise.files.wordpress.com/2015/02/tipos-de-nosql_1_1531662.gif" style="max-width: 80%; position: relative; left: 20%; top:6%;" alt="Ilustración de lenguajes de programación" class="w-full h-auto rounded-lg">
    </div>
</div>
