...
<div class="flex p-9 p-md-5 m-md-3 bg-black">
    <div class="md:w-1/2 mx-auto my-5" style="position: relative; left: 5%; top:10%;">
        <h1 class="text-4xl font-bold text-white text-center mb-4">Desarrollo de Aplicaciones con Kotlin</h1>
        <p class="text-lg mb-4 leading-7 text-white text-justify">Kotlin es un lenguaje de programación moderno que se ha vuelto popular en el desarrollo de aplicaciones para Android. En este curso, explorarás los fundamentos de Kotlin y aprenderás cómo utilizarlo para construir aplicaciones robustas y eficientes.</p>
        <h2 class="text-xl font-bold text-white mb-2">Temas Introductorios</h2>
        <ul class="list-disc text-white ml-6">
            <li>Sintaxis básica y estructuras de control en Kotlin</li>
            <li>Funciones y programación orientada a objetos</li>
            <li>Manejo de excepciones y programación concurrente</li>
            <li>Desarrollo de aplicaciones para Android con Kotlin</li>
            <li>Integración con bibliotecas y servicios</li>
        </ul>
        <br>
    ...
    <div class="md:w-1/2">
        <img src="https://www.autentia.com/wp-content/uploads/2018/06/android-kotlin.gif" style="max-width: 80%; position: relative; left: 20%; top:6%;" alt="Ilustración de lenguajes de programación" class="w-full h-auto rounded-lg">
    </div>
</div>
