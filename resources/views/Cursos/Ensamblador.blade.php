...
<div class="flex p-9 p-md-5 m-md-3 bg-black">
    <div class="md:w-1/2 mx-auto my-5" style="position: relative; left: 5%; top:10%;">
        <h1 class="text-4xl font-bold text-white mb-4 text-center">Introducción a la Programación en Ensamblador</h1>
        <p class="text-lg mb-4 leading-7 text-white text-justify">El lenguaje de programación ensamblador es fundamental para comprender cómo funciona la arquitectura interna de las computadoras. En este curso, explorarás los principios básicos de la programación en ensamblador, proporcionándote una comprensión más profunda del hardware y la ejecución de programas a nivel de máquina.</p>
        <h2 class="text-xl font-bold text-white mb-2">Temas Introductorios</h2>
        <ul class="list-disc text-white ml-6">
            <li>Estructura y sintaxis de ensamblador</li>
            <li>Registros y memoria</li>
            <li>Instrucciones básicas y operaciones aritméticas</li>
    ...
    <div class="md:w-1/2">
        <img src="https://ortizf1522.files.wordpress.com/2016/11/olg.gif" style="max-width: 80%; position: relative; left: 20%; top:6%;" alt="Ilustración de lenguajes de programación" class="w-full h-auto rounded-lg">
    </div>
</div>
