...
<div class="flex p-9 p-md-5 m-md-3 bg-black">
    <div class="md:w-1/2 mx-auto my-5" style="position: relative; left: 5%; top:10%;">
        <h1 class="text-4xl font-bold text-white mb-4 text-center">Programación en Python</h1>
        <p class="text-lg mb-4 leading-7 text-white text-justify">Python es un lenguaje de programación de propósito general conocido por su simplicidad y legibilidad. Es utilizado en una amplia variedad de aplicaciones, desde desarrollo web hasta inteligencia artificial.</p>
        ...
        <ul class="list-disc text-white ml-6">
            ...
            <li>Variables y tipos de datos en Python</li>
    ...
    <div class="md:w-1/2">
        <img src="https://threadwaiting.com/wp-content/uploads/2018/01/TechnicalFeaturesofPython.gif" style="max-width: 60%; position: relative; left: 20%; top:6%;" alt="Ilustración de lenguajes de programación" class="w-full h-auto rounded-lg">
    </div>
</div>
