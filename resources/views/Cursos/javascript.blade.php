...
<div class="flex p-9 p-md-5 m-md-3 bg-black">
    <div class="md:w-1/2 mx-auto my-5" style="position: relative; left: 5%; top:10%;">
        <h1 class="text-4xl font-bold text-white mb-4 text-center">Programación en JavaScript</h1>
        <p class="text-lg mb-4 leading-7 text-white text-justify">JavaScript es un lenguaje de programación versátil y fundamental en el desarrollo web. Permite la creación de páginas interactivas y dinámicas.</p>
        <h2 class="text-xl font-bold text-white mb-2">Temas Introductorios</h2>
        <ul class="list-disc text-white ml-6">
            <li>Sintaxis básica de JavaScript</li>
            <li>Variables y tipos de datos en JavaScript</li>
            <li>Operadores y expresiones</li>
            <li>Estructuras de control en JavaScript</li>
    ...
    <div class="md:w-1/2">
        <img src="https://soyhorizonte.com/wp-content/uploads/2020/10/JS-by-SoyHorizonte.gif" style="max-width: 80%; position: relative; left: 20%; top:6%;" alt="Ilustración de lenguajes de programación" class="w-full h-auto rounded-lg">
    </div>
</div>
