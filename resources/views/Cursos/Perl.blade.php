...
<div class="flex p-9 p-md-5 m-md-3 bg-black">
    <div class="md:w-1/2 mx-auto my-5" style="position: relative; left: 5%; top:10%;">
        <h1 class="text-4xl font-bold text-white mb-4 text-center">Programación en Perl</h1>
        <p class="text-lg mb-4 leading-7 text-white text-justify">Perl es un lenguaje de programación versátil y potente, especialmente conocido por su capacidad para manipular texto y realizar tareas de procesamiento de datos. Es utilizado en una variedad de aplicaciones, desde scripting hasta desarrollo web.</p>
        <h2 class="text-xl font-bold text-white mb-2">Temas Introductorios</h2>
        <ul class="list-disc text-white ml-6">
            <li>Sintaxis básica de Perl</li>
            <li>Variables y tipos de datos en Perl</li>
            <li>Operadores y expresiones regulares</li>
            <li>Estructuras de control en Perl</li>
            <li>Trabajo con archivos y procesamiento de texto</li>
        </ul>
        <br>
    ...
    <div class="md:w-1/2">
        <img src="https://i0.wp.com/unaaldia.hispasec.com/wp-content/uploads/2018/04/db662-perl.gif?resize=320%2C162&ssl=1" style="max-width: 80%; position: relative; left: 20%; top:6%;" alt="Ilustración de lenguajes de programación" class="w-full h-auto rounded-lg">
    </div>
</div>
