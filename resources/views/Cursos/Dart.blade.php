...
<div class="flex p-9 p-md-5 m-md-3 bg-black">
    <div class="md:w-1/2 mx-auto my-5" style="position: relative; left: 5%; top:10%;">
        <h1 class="text-4xl font-bold text-white mb-4 text-center">Programación en Dart</h1>
        <p class="text-lg mb-4 leading-7 text-white text-justify">Dart es un lenguaje de programación desarrollado por Google, diseñado para la creación de aplicaciones web y móviles. Es conocido por su rendimiento y su uso en el desarrollo de aplicaciones con el framework Flutter.</p>
        ...
        <ul class="list-disc text-white ml-6">
            ...
            <li>Variables y tipos de datos en Dart</li>
            <li>Funciones y control de flujo</li>
            <li>Programación orientada a objetos en Dart</li>
            <li>Desarrollo de aplicaciones con Flutter</li>
        </ul>
        <br>
    ...
    <div class="md:w-1/2">
        <img src="https://miro.medium.com/v2/resize:fit:1400/1*bYuD5OBj28zyea3-K2bdHQ.gif" style="max-width: 80%; position: relative; left: 20%; top:6%;" alt="Ilustración de lenguajes de programación" class="w-full h-auto rounded-lg">
    </div>
</div>
