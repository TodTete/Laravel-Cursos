...
<div class="flex p-9 p-md-5 m-md-3 bg-black">
    <div class="md:w-1/2 mx-auto my-5" style="position: relative; left: 5%; top:10%;">
        <h1 class="text-4xl font-bold text-white mb-4 text-center">Desarrollo Empresarial con COBOL</h1>
        <p class="text-lg mb-4 leading-7 text-white text-justify">COBOL (Common Business Oriented Language) es un lenguaje de programación diseñado para aplicaciones empresariales. En este curso, explorarás cómo utilizar COBOL para el desarrollo de software empresarial, centrándote en la eficiencia y la confiabilidad.</p>
        <h2 class="text-xl font-bold text-white mb-2">Temas Introductorios</h2>
        <ul class="list-disc text-white ml-6">
            <li>Sintaxis y estructuras básicas de COBOL</li>
            <li>Manipulación de datos y archivos</li>
            <li>Programación orientada a transacciones</li>
            <li>Interacción con sistemas de bases de datos</li>
            <li>Desarrollo de aplicaciones empresariales prácticas</li>
        </ul>
        <br>
    ...
    <div class="md:w-1/2">
        <img src="https://www.neoteo.com/wp-content/uploads/2022/04/perform_add.gif" style="max-width: 80%; position: relative; left: 20%; top:6%;" alt="Ilustración de lenguajes de programación" class="w-full h-auto rounded-lg">
    </div>
</div>
