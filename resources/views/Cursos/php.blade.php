...
<div class="flex p-9 p-md-5 m-md-3 bg-black">
    <div class="md:w-1/2 mx-auto my-5" style="position: relative; left: 5%; top:10%;">
        <h1 class="text-4xl font-bold text-white mb-4 text-center">Desarrollo Web con PHP</h1>
        <p class="text-lg mb-4 leading-7 text-white text-justify">PHP es un lenguaje de scripting utilizado principalmente en el desarrollo web. Es conocido por su flexibilidad y capacidad para integrarse con HTML. Aprender PHP te permitirá crear aplicaciones web dinámicas e interactivas.</p>
        <h2 class="text-xl font-bold text-white mb-2">Temas Introductorios</h2>
        <ul class="list-disc text-white ml-6">
            <li>Sintaxis básica de PHP</li>
            <li>Variables y tipos de datos en PHP</li>
            <li>Estructuras de control y bucles</li>
            <li>Funciones y manipulación de arrays</li>
            <li>Desarrollo de formularios web</li>
            <li>Conexión a bases de datos con MySQL</li>
    ...
    <div class="md:w-1/2">
        <img src="https://d2a5isokysfowx.cloudfront.net/wp-content/uploads/2022/02/%C2%BFQue-es-el-lenguaje-de-programacion-PHP-scaled-1200x900.jpg" style="max-width: 80%; position: relative; left: 20%; top:6%;" alt="Ilustración de lenguajes de programación" class="w-full h-auto rounded-lg">
    </div>
</div>
